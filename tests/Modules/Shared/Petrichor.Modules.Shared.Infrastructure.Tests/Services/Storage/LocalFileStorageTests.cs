using Petrichor.Modules.Shared.Infrastructure.Services.Storage;

namespace Petrichor.Modules.Shared.Infrastructure.Tests.Services.Storage;
...
public class LocalFileStorageTests : IDisposable
{
    ...
    {
        _testDataFolder = Path.Combine(Path.GetTempPath(), $"{Guid.CreateVersion7()}");
